...
namespace Nauch
{
    public partial class Calculated_Form5 : Form
    {
        ...
        private void Calculated_Form5_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string t1_zapros = "SELECT t1 FROM Sposob5 WHERE Код =" + textBox1.Text;
            string t2_zapros = "SELECT t2 FROM Sposob5 WHERE Код =" + textBox1.Text;
            string N1_zapros = "SELECT N1 FROM Sposob5 WHERE Код =" + textBox1.Text;
            string N2_zapros = "SELECT N2 FROM Sposob5 WHERE Код =" + textBox1.Text;
            try
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sposob = "5 способ(" + textBox1.Text + " код)";
